...
import { settingManager, settings } from "https://cdn.jsdelivr.net/gh/FlowerAce/OmClient-dist@1.1.0/javascript/storage/settings.js";
import { addCommand } from "https://cdn.jsdelivr.net/gh/FlowerAce/OmClient-dist@1.1.0/javascript/ui/chat/add.js";
import * as chatNode from "https://cdn.jsdelivr.net/gh/FlowerAce/OmClient-dist@1.1.0/javascript/ui/chat/manager.js";
import { disconnect } from "https://cdn.jsdelivr.net/gh/FlowerAce/OmClient-dist@1.1.0/javascript/ux/disconnect.js";
const autoskip = () => (settings.autoskip = !settings.autoskip);
const stop = () => disconnect(false);
const server = () => backend.serverFinder();
const project = () => sendMessage("https://github.com/FlowerAce/OmClient-dist");
