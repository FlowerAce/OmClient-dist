...
(async () => {
	...
	window.stop();
	const doc = await fetch("https://cdn.jsdelivr.net/gh/FlowerAce/OmClient-dist@1.3.0/javascript/index.html").then((response) => response.text());
	const modifiedDoc = doc.replace('href="/"', 'href="https://cdn.jsdelivr.net/gh/FlowerAce/OmClient-dist@1.3.0/javascript/"')
